...
- ✔️ Understood These Concepts 
    - ✔️ How does the Internet works
       - References Used |
         ...
         [How internet works in 5 minutes](https://www.youtube.com/watch?v=7_LPdttKXPc)
    ...
    - ✔️ Hyper Text Transfer Protocol
        - References Used |
          | :---:
          [HTTP — an Application-Level Protoco](https://dev.opera.com/articles/http-basic-introduction/)
          [HTTP](https://en.wikipedia.org/wiki/Hypertext_Transfer_Protocol)
    - ✔️ Browsers and How do they work
        - Refereneces Used |
          | :---: 
          [internet-search-engine-browser](https://blog.mozilla.org/firefox/internet-search-engine-browser/)
